...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <link rel="icon" href="{{ asset('public/img/icono/casagoza.ico') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('public/css/meta.css?v='.$version) }} "/>


    <title>Casa Goza - Inicio Sessión</title>
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
              ...
              <img src="{{ asset('public/img/casagoza.png') }}" alt="logo" width="150" height="150" class="logo-img">
